...
import { AvailabilityTags } from '@repo/components/availability-tags';
    ...
    <div className='min-h-screen bg-background flex flex-col'>
      ...
      <main className='flex-1 container mx-auto px-4 py-12 flex flex-col items-center justify-center'>
        <div className='max-w-2xl mx-auto text-center'>
          ...
          <h1 className='text-5xl font-bold mt-8 mb-4 text-foreground'>{brand.title}</h1>

          <p className='text-2xl font-medium mb-4 text-muted-foreground'>{brand.tagline}</p>

          <p className='text-lg text-muted-foreground mb-8'>{brand.description}</p>
